...
class FlakyDetector:
    ...
    # FIXME(remyduthu): Not working with pytest-xdist. Metrics should be shared across
    # workers.
    ...
    def _get_budget_duration(self) -> datetime.timedelta:
        ...
        extra_duration = ratio * total_duration
        budget_duration = max(
            total_duration + extra_duration, self._context.min_budget_duration
        )
        self.log_messages.append(
