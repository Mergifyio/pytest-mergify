...
class FlakyDetector:
    ...
    def _count_remaining_tests(self) -> int:
        # Metrics are not initialized before initial run of each. It can't work like this. We should use the context instead.
        ...
        return max(len(tests) - len(processed_tests), 1)
