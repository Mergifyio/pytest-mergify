...
class FlakyDetector:
    ...
    def initialize_from_session(self, session: _pytest.main.Session) -> None:
        ...
        existing_tests_total_duration = (
            self._context.existing_tests_mean_duration * len(existing_tests_in_session)
        )

        self._available_budget_duration = max(
            budget_ratio * existing_tests_total_duration,
